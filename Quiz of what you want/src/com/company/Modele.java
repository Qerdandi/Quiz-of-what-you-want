...
public class Modele {
    ...
    public HashMap<String, String> readFileAndPath(String path){
        System.out.println("Début de la lecture du fichier "+path);
    ...
    public void readFileSelected()
    {
        ...
        for (String file : fileAndPath.keySet()) {
            System.out.println("Début de la lecture du fichier "+file);
            System.out.println("Fichier "+Paths.get(file)+" trouvé : " + Files.exists(Paths.get(file)));
            try{
    ...
    public String randomImagePath(){
        try {
            ...
            System.out.println("Réponse générée : "+ currentAnswerKey);
            System.out.println("Chemin généré : "+currentPathValue);
